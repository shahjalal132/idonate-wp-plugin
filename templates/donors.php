...
if( ! idonate_user_logged_in_donor_show() ) {
	echo '<div class="container"><div class="row"><div class="col-sm-6 offset-3"><h3 class="alert mt-30 text-center alert-danger">'.esc_html__( 'You have to logged in to see donor', 'idonate' ).'</h3></div></div></div>';
	return false;
}
?>
		...
		<div class="col-sm-4">
			<div class="donor-item">
				...
				<div class="donors-info">
					...
					<p><i class="fa fa-object-group"></i><?php echo get_user_meta( $user->ID, 'idonate_donor_bloodgroup', true ); ?></p>
					...
					?>
					<a href="<?php echo site_url('donor-info?donor_id='.$user->ID ); ?>" class="btn btn-primary"><?php esc_html_e( 'View Details', 'idonate' ); ?></a>
					<?php
					else:
					?>
					<button type="button" href="#<?php echo esc_attr( $uid ); ?>" class="btn btn-primary open-popup-link" data-target="#<?php echo esc_attr( $uid ); ?>">
