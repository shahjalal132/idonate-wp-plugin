					...
					<table id="table_id" class="table donor-table table-bordered display">
						...
						<tbody>
							...
							foreach ( $users as $user ) :
								...
								// Check if the donor is available
								$av = get_user_meta( $user->ID, 'idonate_donor_availability', true );
								if ( 'available' == $av ) {
									continue; // Skip this donor if they are available
								}
								...
								<tr>
									...
									<td>
										<?php echo esc_html( get_user_meta( $user->ID, 'idonate_donor_full_name', true ) ); ?>
									</td>
									<td>
										<?php echo esc_html( get_user_meta( $user->ID, 'idonate_donor_bloodgroup', true ) ); ?>
									</td>
									<td>
										<?php echo esc_html( get_user_meta( $user->ID, 'idonate_donor_mobile', true ) ); ?>
									</td>
									<td>
									...
									<td class="text-center">
										<i class="fa fa-eye donor-preview open-popup-link"
											href="#tbleuser<?php echo esc_attr( $user->ID ); ?>"></i>
									</td>
								</tr>
								<!-- Modal -->
