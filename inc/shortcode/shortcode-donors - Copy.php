...
add_shortcode( 'donors' , 'shortcode_donors' );
function shortcode_donors() {
						...
						<div class="row">
							<div class="col-sm-4">
								<select class="form-control" name="bloodgroup">
									<option><?php esc_html_e( 'Select Blood Group', 'idonate' ); ?></option>
									<?php 
								...
								<select class="form-control" name="availability">
									<option><?php esc_html_e( 'Select Availability', 'idonate' ); ?></option>
							...
							<div class="col-sm-4">
								<input type="text" name="city" class="form-control" placeholder="<?php esc_attr_e( 'Write city name', 'idonate' ); ?>" /> 
								<input type="submit" class="btn btn-primary" value="<?php esc_html_e( 'Search Donor', 'idonate' ); ?>" />
							</div>
						</div>
					</form>
				</div>
			...
			<div class="col-sm-4">
				<div class="donor-item">
					...
					<div class="donors-info">
						<p><i class="fa fa-user"></i><?php echo get_user_meta( $user->ID, 'idonate_donor_full_name', true ); ?></p>
						<p><i class="fa fa-object-group"></i> <strong></strong><?php echo get_user_meta( $user->ID, 'idonate_donor_bloodgroup', true ); ?></p>
						<p><i class="fa fa-universal-access"></i><span class="<?php echo esc_attr( $abclass ); ?>"><?php echo esc_html( $av ).wp_kses_post( $signal ) ; ?></span></p>
						<p><i class="fa fa-map-marker"></i><?php echo esc_html( get_user_meta( $user->ID, 'idonate_donor_city', true ) ) ; ?></p>
						<p><i class="fa fa-mobile"></i><?php echo get_user_meta( $user->ID, 'idonate_donor_mobile', true ); ?></p>
						<!-- Button trigger modal -->
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#<?php echo esc_attr( $uid ); ?>">
						</div>
				...
				<!-- Modal -->
				<div class="modal fade" id="<?php echo esc_attr( $uid ); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel"><?php echo esc_html( $formText ); ?></h4>
					  ...
					  <div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal"><?php esc_html_e( 'Close', 'idonate' ); ?></button>
					  </div>
					</div>
				  </div>
				</div>
